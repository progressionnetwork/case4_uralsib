    ...
    var _barsTornadosExamples = function() {
        ...
        if (bars_basic_element) {
            ...
            bars_basic.setOption({
                 ...
                 // Add title
                 title: {
                    text: 'Тенденция популярности услуг',
        ...
        if (bars_stacked_element) {
            ...
            bars_stacked.setOption({
                ...
                // Add legend
                legend: {
                    data: ['Другие услуги','Кредиты','ИП и Самозаняты','Кредитные карты','Дебетовые карты'],
                    itemHeight: 8,
                    itemGap: 20,
                    textStyle: {
                        padding: [0, 5]
                ...
                yAxis: [{
                    type: 'category',
                    data: ['18-21', '21-25', '25-29', '29-34', '34-39', '39-45', '45-70'],
                    axisLabel: {
                        color: '#333'
                    },
                    axisLine: {

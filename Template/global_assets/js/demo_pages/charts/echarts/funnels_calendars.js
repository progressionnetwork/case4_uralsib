    ...
    var _funnelsCalendarsExamples = function() {
        ...
        if (funnel_basic_element) {
            ...
            funnel_basic.setOption({
                ...
                legend: {
                    ...
                    top: 'center',
                    left: 0,
                    data: ['Дебетовые карты','Кредитные карты','Кредиты','ИП и Самозанятые','Другое'],
                    itemHeight: 8,
                    itemWidth: 8
                },
                ...
                series: [
                    {
                        ...
                        data: [
                            {value: 60, name: 'Другое'},
                            {value: 40, name: 'ИП и Самозанятые'},
                            {value: 20, name: 'Кредиты'},
                            {value: 80, name: 'Кредитные карты'},
                            {value: 100, name: 'Дебетовые карты'}
                        ]
                    }
                ]
            });
        ...
        if (funnel_sorting_element) {
            ...
            funnel_sorting.setOption({
                ...
                // Add title
                title: {
                    text: 'Популярность услуг по городам',
                    subtext: 'На основе анализа Bigdata',
                    left: 'center',
                    textStyle: {
                        fontSize: 17,
                        fontWeight: 500
                ...
                legend: {
                    ...
                    top: 'center',
                    left: 0,
                    data: ['Москва','Санкт-Питербург','Новосибирск','Самара','Краснодар'],
                    itemHeight: 8,
                    itemWidth: 8
                },
                ...
                series: [
                    {
                        ...
                        data: [
                            {value: 60, name: 'Краснодар'},
                            {value: 40, name: 'Самара'},
                            {value: 20, name: 'Новосибирск'},
                            {value: 80, name: 'Санкт-Питербург'},
                            {value: 100, name: 'Москва'}
                        ]
                    }
                ]
            });
